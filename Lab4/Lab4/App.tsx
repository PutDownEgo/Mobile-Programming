...
function ContactsScreens() {
  return (
    <Stack.Navigator initialRouteName='Contacts' screenOptions={{headerShown: true}}>
      ...
      <Stack.Screen name='ProfileContract' component={ProfileContact} options={{title:"Profile contact"}}/>
    </Stack.Navigator>
  )
}
...
const TabNavigator = () => {
  return(
    <Tab.Navigator initialRouteName='ContactsScreens' barStyle={{backgroundColor: 'blue'}}
                  labeled={false}
                  activeColor={"blue"}
                  inactiveColor={'grey'}>
                    <Tab.Screen name='Contacts' component={ContactsScreens} options={{tabBarIcon: 'format-list-bulleted'}}/>
                    <Tab.Screen name='Favorites' component={FavoriteScreens} options={{tabBarIcon: 'star-check'}}/>
    </Tab.Navigator>
  )
}
